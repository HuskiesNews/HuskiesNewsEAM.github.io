...
(function() {
  ...
  function startSlideshow() {
    ...
    function showSlide(message) {
      ...
      slides[message].classList.add("active");
      currentSlideMessage = message;
    }
  
    function showNextSlide() {
      showSlide(currentSlideMessage + 1);
    }
    ...
    interval = setInterval(showNextSlide, 20000);
  
    // Clear and reset the interval when the document visibility changes
